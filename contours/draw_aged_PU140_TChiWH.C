...
void draw_aged_PU140_TChiWH(TString infile = "contours_TChiWH.root") {
  ...
  // g_signif_aged_1000fb->SetLineWidth(3);
  // g_signif_aged_1000fb->SetLineStyle(3);
  // g_signif_aged_1000fb->SetLineColor(kOrange+10);
  ...
  c1->SaveAs("contours_agedcomp_PU140.eps");
  c1->SaveAs("contours_agedcomp_PU140.pdf");
}
