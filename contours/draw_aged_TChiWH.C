...
void draw_aged_TChiWH(TString infile = "contours_TChiWH.root") {
  ...
  g_signif_PhaseII_1000fb->SetLineColor(kBlue-10);
  ...
  g_signif_aged_combined_1000fb->SetLineWidth(3);
  g_signif_aged_combined_1000fb->SetLineStyle(1);
  g_signif_aged_combined_1000fb->SetLineColor(kYellow+3);
  g_signif_aged_combined_1000fb->Draw("l same");
  ...
  leg->AddEntry(g_signif_aged_combined_1000fb,"1000 fb^{-1} Aged","l");
